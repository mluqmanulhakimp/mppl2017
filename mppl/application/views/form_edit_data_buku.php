...
<!-- !PAGE CONTENT! -->
  ...
  <div style="background: #6E6E6E;height: 54px;width: 100%">
    <a style="font-size: 33px;padding-left: 20px;color: #f7f7f7;"><font face="Times New Roman">Ubah Data Buku</font></a>
 ...
 -->  </div>
  ...
  <header id="portfolio">
    ...
    <div class="w3-section w3-topbar w3-padding-16;3-section w3-bottombar w3-padding-16">
      <form method="POST" action="<?php echo "http://localhost/mppl/index.php/ctr/do_edit_data_buku/".$data['idbuku'];?>">
        <table>
          <tr>
            <td>Judul</td>
          ...
          <tr>
            <td>Edisi</td>
            <td><input type="text" name="edisi" value="<?php echo $data['edisi'] ?>"></td>
          </tr>
          <tr>
            <td>Pengarang</td>
