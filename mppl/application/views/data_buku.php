    ...
    <!--ISI-->
      ...
      <h3 style="text-align: center;"></h3>
        <tr style="background: #C9C9C9;">
          <th width="29%" style="padding-top: 10px;padding-bottom: 10px">Judul</th>
          <th width="8%" style="padding-top: 10px;padding-bottom: 10px">Edisi</th> 
        ...
        <tbody style="background: #FCFCFC;">
          ...
          <tr>   
              ...
              <td style="padding-left: 10px"><?php echo $row['pengarang']; ?></td>
              <td style="padding-left: 10px"><?php echo $row['kategori']; ?></td>
