...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:250px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block" style="margin-left: 10px">
    <a href="# onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Beranda</a> 
  ...
  <header id="portfolio">
   ...
   <!--    <div style="padding-top: 20px; padding-bottom: 20px">
      ...
      <div style="padding-top: 10px;padding-bottom: 10px">
        <a style="margin-left: 400px" href="<?php echo "http://localhost/mppl/index.php/ctr/insert_data_peminjaman/";?>"><button style="" name="subject" type="submit" value="HTML">Tambah Data Peminjaman</button></a>
        <form style="margin-top: -37px;padding-top: 8px" method="get" action="<?php echo "http://localhost/mppl/index.php/ctr/search_peminjaman/"?>">
